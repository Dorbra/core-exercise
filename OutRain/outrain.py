...
WEATHER_URL_TEMPLATE = 'http://api.openweathermap.org/data/2.5/weather?lat={}&lon={}&appid={}&units=metric'
...
def weather(lat, lon, city, country):
        weather_url = WEATHER_URL_TEMPLATE.format(lat, lon, WEATHER_API_KEY)
